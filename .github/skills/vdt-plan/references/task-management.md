...
- **Sync-bavdt:** Update `[ ]` → `[x]` in phase files, update plan.md frontmatter status
...
1. User runs `/vdt:cook path/to/plan.md` in new session
...
2. `project-manager` subagent runs full-plan sync-bavdt:
