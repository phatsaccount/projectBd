...
### Step 2: Summarize the plans and document them with `/vdt:journal` skill invocation
...
- Stage and commit the changes (Use `/vdt:git` for commit flow)
- Commit and push the changes (Use `/vdt:git` for push flow)
