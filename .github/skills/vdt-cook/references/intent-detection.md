...
```
"/vdt:cook implement user auth --interactive"
→ Mode: interactive (explicit flag, stops at review gates)

"/vdt:cook implement user auth"
→ Mode: interactive (default, stops at review gates)

"/vdt:cook plans/260120-auth/phase-02-api.md"
→ Mode: code (path detected, stops at review gates)

"/vdt:cook quick fix for the login bug"
→ Mode: fast ("quick" keyword, stops at review gates)

"/vdt:cook implement auth, payments, notifications, shipping"
→ Mode: parallel (4 features, stops at review gates)

"/vdt:cook implement dashboard --fast"
...
"/vdt:cook implement everything --auto"
→ Mode: auto (NO STOPS, implements all phases continuously)

"/vdt:cook implement dashboard trust me"
