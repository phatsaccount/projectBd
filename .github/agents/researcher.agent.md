...
memory: user
---
description: "Use this agent when you need to conduct comprehensive research on software development topics, including new technologies, documentation, best practices, and comparative analysis."
